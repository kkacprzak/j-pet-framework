...
long long JPetReader::getCurrentEntryNumber() const { return fCurrentEntryNumber; }

long long JPetReader::getNbOfAllEntries() const { return fTree ? fTree->GetEntries() : 0; }
