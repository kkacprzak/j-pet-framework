...
void JPetTask::setName(const std::string& name) { fName = name; }

std::string JPetTask::getName() const { return fName; }

void JPetTask::addSubTask(std::unique_ptr<JPetTaskInterface> subTask) { fSubTasks.push_back(std::move(subTask)); }
