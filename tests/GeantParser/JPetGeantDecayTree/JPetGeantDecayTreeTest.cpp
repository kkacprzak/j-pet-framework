...
// TODO - update the tests to new structures
...
BOOST_AUTO_TEST_CASE(branch_nonstandard_constructor)
{
  ...
  // JPetGeantDecayTreeBranch branch(trackID, primaryBranchID);
  //
...
BOOST_AUTO_TEST_CASE(check_decayTree_creation_and_getting_branch)
{
  ...
  //
  // JPetGeantDecayTreeBranch firstBranch = decayTree.GetBranch(firstTrackID);
  // JPetGeantDecayTreeBranch secondBranch = decayTree.GetBranch(secondTrackID);
  // JPetGeantDecayTreeBranch thirdBranch = decayTree.GetBranch(thirdTrackID);
  //
